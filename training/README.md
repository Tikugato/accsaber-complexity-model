...
The maps to train on are the ranked pool, and the labels are our own players' scores, which the backend exports as CSV from `/v1/admin/complexity/dataset/scores` with a staff token.
